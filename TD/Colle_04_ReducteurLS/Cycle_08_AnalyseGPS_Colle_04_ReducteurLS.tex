...
\def\xxtitreexo{Réducteur Leroy Somer}
...
\begin{rem}
On a : $\phi 70 h6 = \phi 70 ^{\begin{tabular}{l}0 \\ -0,019\end{tabular}}$
\end{rem}
...
\begin{center}
\rotatebox{90}{\includegraphics[width=\textheight]{images/reducteur_03}}
\end{center}
